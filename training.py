...
with col1img:
    st.header('Balbo')
    st.image('https://upload.wikimedia.org/wikipedia/it/thumb/c/c1/Abel_Balbo_-_AS_Roma_1995-96.jpg/960px-Abel_Balbo_-_AS_Roma_1995-96.jpg')
with col2img:
    st.header('Fonseca')
    st.image('https://upload.wikimedia.org/wikipedia/it/thumb/d/dc/Daniel_Fonseca_-_AS_Roma_1994-95.jpg/896px-Daniel_Fonseca_-_AS_Roma_1994-95.jpg?20161201173236')
